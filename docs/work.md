...
prerequisite named and routed to the development manager's docket, which the
paragraph after that is about. And an item **held by a step only a person can
take** is passed over with that step named and with what records it, which the
last of the paragraphs below is about. The other
...
Sequencing is the one of those eight that is a wait rather than a refusal. Two
