...
in total is still [`execution.check_timeout`](configuration/runs.md#how-long-a-check-may-take),
...
[workflow definition](configuration/goals.md#the-release-readiness-workflow) — data in
