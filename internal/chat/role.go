...
// remembers, reports, and may record a restart request that nothing acts on yet,
// and every tracker write it holds is scoped to a lane nothing enforces yet, so
// each is refused.
