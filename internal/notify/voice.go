...
var harnessVoice = voice{
	...
	lines: map[Kind]string{
		...
		KindProviderWindow:      "Nothing is being chosen on this product for {age}: {stopped}. Nothing has stopped and nothing is waiting on anybody — the harness asks again when the window lifts.\n\n{standing}",
...
var developerVoice = voice{
	...
	lines: map[Kind]string{
		...
		KindProviderWindow:      "Nothing has been handed to me for {age}: {stopped}. That is not a queue nobody is reading — there is nothing to pick up until the provider serves again.\n\n{standing}",
...
var reviewerVoice = voice{
	...
	lines: map[Kind]string{
		...
		KindProviderWindow:      "No change has reached me for a verdict in {age}: {stopped}. Nothing was written for me to judge, and nothing was going to be.\n\n{standing}",
...
var developmentManagerVoice = voice{
	...
	lines: map[Kind]string{
		...
		KindProviderWindow:      "My queue has not been pulled from for {age}: {stopped}. The order stands as I set it, and the next pull takes it from the top when the window lifts.\n\n{standing}",
...
var productManagerVoice = voice{
	...
	lines: map[Kind]string{
		...
		KindProviderWindow:      "Nothing has been spent on this product for {age}: {stopped}. This is the one quiet stretch that costs nothing and buys nothing, and it ends on the provider's clock rather than on anybody's decision.\n\n{standing}",
...
var architectVoice = voice{
	...
	lines: map[Kind]string{
		...
		KindProviderWindow:      "Selection has chosen nothing for {age}: {stopped}. The loop is alive and reading the queue; what it would start with is what the provider will not serve yet.\n\n{standing}",
