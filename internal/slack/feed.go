...
type HarnessFeed struct {
	...
	// thread, and by whom. It is what separates a directive to answer somebody
	// about from one typed at a terminal, which has no thread and nobody to tag,
	// and it is read here and written only by the connection.
	Steers *Store
...
// what settled it — and that is said where they asked.
//
