...
func escalatingPipeline(t *testing.T, tracker *orchestratortest.Tracker, provider *orchestratortest.Backend) (Pipeline, *runstate.Store, *runstate.DocketStore) {
	t.Helper()
...
func TestADeveloperEscalationRunsNoChecksAndPublishesNothing(t *testing.T) {
	...
	provider := orchestratortest.RoleBackend(func(request backend.RunRequest) error { return nil }, approveVerdict)
