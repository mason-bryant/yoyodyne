...
// repository.
//
// A developer run is one of the two populations that can type a replacing write
// into Bash, and `beads.Client.Update` covers neither: that only makes the
// writes the harness issues safe, and an agent can type
