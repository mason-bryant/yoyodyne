...
func TestThePageRendersEverySectionInEveryState(t *testing.T) {
	...
	for scenario, expectations := range map[string][]string{
		...
		"grouping-pile":    {`Held back: held for a person (2 items)`, "whose move: the development manager's", `data-item="yoyodyne-ifd.153"`, `data-item="yoyodyne-ifd.150"`},
		"grouping-landed":  {`Landed last 7 days (22 items)`, "from 2026-09-13, local days, newest first", `data-item="yoyodyne-ifd.439"`, "landed 2026-09-19 13:41:00", `data-item="yoyodyne-ifd.406"`},
	...
	// A closed pop-up is not in the render at all, and the render that closed
	// both with Escape is the busy page again.
