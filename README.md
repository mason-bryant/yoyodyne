...
conversation down: `yoyo chat --message` in another terminal, anything else the
harness runs, and a second `yoyo chat` you leave open beside the first all reach
...
conversation is yours until it ends.
